...
1. Start with triple double quotes on the first line and then a single-line summary in the imperative mood on the next
line.
...
Formatting rules:
1. List each item within "Imports", "Classes", and "Functions" and indent properly. Only go one
...
Formatting rules:
1. List each item within "Attributes" and "Methods" and indent properly.
2. Ensure the docstring lines do not exceed 120 characters.
...
Formatting rules:
1. List each parameters within "Args" and "Raises" and indent properly.
2. Avoid including a typical usage section.
2. Ensure the docstring lines do not exceed 120 characters.
4. Only output the docstring without any additional information or comments.
"""
