def get_module_prompt(module_content: str) -> str:
    return f"""
    You are a professional and experienced software engineer. Review the design and implementation of the Python module
    provided below, ensuring it adheres to software engineering best practices.
...
def get_class_prompt(class_content: str) -> str:
    return f"""
    You are a professional and experienced software engineer. Review the design and implementation of the Python class
    provided below, ensuring it adheres to software engineering best practices.
...
def get_function_prompt(function_content: str) -> str:
    return f"""
    You are a professional and experienced software engineer. Review the design and implementation of the Python
    function provided below, ensuring it adheres to software engineering best practices.
